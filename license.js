...
const date = new Date();
const darkpayMarket = '// Copyright (c) 2017-' + String(date.getFullYear()) + ', The Darkpay Market developers';
const underLicense = '// Distributed under the GPL software license, see the accompanying';
const licenseLink = '// file COPYING or https://github.com/DarkPayCoin/darkpay-market/blob/develop/LICENSE';
...
function add(filename) {
    ...
    prepend(filename, darkpayMarket + '\n' + underLicense + '\n' + licenseLink + '\n', function(error) {
