...
export class BidRejectActionListener extends BaseActionListenr implements interfaces.Listener, ActionListenerInterface {
    ...
    constructor(
        ...
        super(MPAction.MPA_REJECT, smsgMessageService, bidService, proposalService, Logger);
    }
