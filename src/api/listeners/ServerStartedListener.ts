    ...
    private async checkConnection(): Promise<boolean> {
        ...
        if (isConnected) {
            ...
            if (this.previousState !== isConnected) {
                this.log.info('connection with darkpayd established.');
            ...
            // this.log.info('connected to darkpayd, checking again in ' + this.interval + 'ms.');
        } else {

            if (this.previousState !== isConnected) {
                this.log.info('connection with darkpayd disconnected.');
            ...
            if (process.env.NODE_ENV !== 'test') {
                this.log.error('failed to connect to darkpayd, retrying in ' + this.interval + 'ms.');
            }
        }
