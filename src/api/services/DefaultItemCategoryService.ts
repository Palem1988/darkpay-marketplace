...
export class DefaultItemCategoryService {
    ...
    public async seedDefaultCategories(): Promise<void> {
        ...
        let LEVEL1CHILD = await this.insertOrUpdateCategory({ key: 'cat_darkpay', name: 'Darkpay', description: '', parent_item_category_id: ROOT.Id } as ItemCategoryCreateRequest);
        await this.insertOrUpdateCategory({ key: 'cat_darkpay_free_swag', name: 'Free Swag', description: '', parent_item_category_id: LEVEL1CHILD.Id } as ItemCategoryCreateRequest);
