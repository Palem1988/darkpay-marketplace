...
export class CoreRpcService extends CtRpc {
    ...
    private DEFAULT_MAINNET_PORT = 56668;
    private DEFAULT_TESTNET_PORT = 46668;
    ...
    /**
     * ﻿Returns a new Darkpay address for receiving payments, key is saved in wallet.
     *
...
*/
    ...
    /**
     * ﻿﻿Return information about the given darkpay address. Some information requires the address to be in the wallet.
     *
     * example result:
     * {
     ...
     * [1] "keys",          (string, required) A json array of darkpay addresses or hex-encoded public keys
     *      [
     *          "address"   (string) darkpay address or hex-encoded public key
     *          ...,
     *      ]
...
*/
    ...
    /**
     * ﻿DEPRECATED. Returns the current Darkpay address for receiving payments to this account.
     *
     * @param {string} account
     * @returns {Promise<any>}
     */
