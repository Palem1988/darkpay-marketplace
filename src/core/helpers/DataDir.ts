 ...
 * ------------------------------------
 *
 * Manages the data directories for darkpay-market.
 *
 *  Linux:
 *  OSX:
 *  Windows:
...
export class DataDir {
    ...
    public static initialize(env: EnvConfig): boolean {
        ...
        // may also be the darkpay-market/testnet
    ...
    public static createDefaultEnvFile(): Promise<boolean> {
        return new Promise((resolve, reject) => {
            ...
            // /somepath/darkpay-market/srcORdist/core/helpers -> /somepath/darkpay-market/srcORdist/
