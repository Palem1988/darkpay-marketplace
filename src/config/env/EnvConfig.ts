...
export class EnvConfig {
    ...
    private defaultEnv = {
        ...
        DEFAULT_MARKETPLACE_PRIVATE_KEY: '7sFRU8TmN5XrymUWPA8S1FoHSCUMLJGYtbrVSKhbMjG8Gk4MhL9f',
        DEFAULT_MARKETPLACE_ADDRESS: 'diz63T6wyxebGVb6ccFcs4NYdZRgeG1oMC',
